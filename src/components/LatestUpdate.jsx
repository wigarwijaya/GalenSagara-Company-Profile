          ...
          >
            <div className="rounded h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
              ...
              <div className="p-6 absolute bottom-0 bg-white/70 ss:w-full">
                ...
                <p className="leading-relaxed mb-3 text-black">{t("latestUpdate.services.construction.content",{content:text.text1})}</p>
          ...
          >
            <div className="rounded h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
              ...
              <div className="p-6 absolute bottom-0 bg-white/70">
                ...
                <p className="leading-relaxed mb-3 text-black">{t("latestUpdate.services.non-construction.content",{content:text.text2})}</p>
                <div className="flex items-center flex-wrap ">
                  <Link
